    ...
    io.on('connection', (socket) => {
        ...
        socket.on('MarkNotification', async ({ NotificationsId, Message, Checked }) => {
            ...
            if (Checked === true) {
                ...
                let InstituteUserData = await UserModel.findOne({
                    where: {
                        InstituteUserId: Noti.FromUserId
                    }
                })
                console.log(InstituteUserData.dataValues);
                console.log(InstituteUserData.dataValues.UserId);
